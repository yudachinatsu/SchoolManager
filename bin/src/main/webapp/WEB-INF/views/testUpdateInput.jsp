...
<body>
	...
	<div id="data">
		...
		<form:form action="testUpdateConfirm" modelAttribute="testUpdate">
			<c:if test="${not empty errMsg}">
				<span class="error">${fn:escapeXml(errMsg)}</span>
			</c:if>

			<span class="error"> <form:errors path="testId" class="error"></form:errors></span>
			<br>

			<span class="error"> <form:errors path="testName"
					class="error"></form:errors></span>
			<fieldset>
				<div>
					<label>テストID</label>
				...
				<div>
					...
					<button name="back" class="submit_btn">戻る</button>
				</div>
			</fieldset>
		</form:form>
		<div>
