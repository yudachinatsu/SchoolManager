...
<body>
	...
	<form:form action="testSelectUpdate" method="post"
		modelAttribute="testSelect">
		<div id="data">
			<table>
				...
				<tbody>
					<tr>
						<td>${fn:escapeXml(editTest.id)}</td>
						<td>${fn:escapeXml(editTest.name)}</td>
					</tr>
				</tbody>
			</table>
			<div>
